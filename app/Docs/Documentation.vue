<template>
  <section class="index-page wrapper">
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand  navbar-brand-centered" href="/">CORE</a>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2">
            <div class="brand">
              <h1>Documentaion for Empari Material UI Kit</h1>
...
&lt;button class=&quot;btn btn-primary btn-xs&quot;&gt;Extra Small&lt;/button&gt;
          ...
          <p>
            ...
            <button class="btn btn-default btn-round">Round</button>
...
&lt;button class=&quot;btn btn-primary btn-simple&quot;&gt;Simple&lt;/button&gt;
          ...
          <p>
            Button groups and disabled state all work like they are supposed to. We used the
            Font Awesome icons that can be found <a
            href="http://fortawesome.github.io/Font-Awesome/icons/" target="_blank">here</a>
            and Material Design Icons that can be found <a
        ...
        <div class="tim-row" id="checkbox-row">
          ...
          <legend></legend>
          <p>
            To use the custom checkboxes, you don't need to import any separate Javascript file,
            everything is inside material.min.js
          </p>
          <p>
          <div class="checkbox">
            <label>
...
&lt;/div&gt;
        ...
        <div class="tim-row" id="radio-row">
          ...
          <legend></legend>
          <p>
            To use the custom radio buttons, you don't need to import any separate Javascript
            file, everything is inside material.min.js.
          </p>
          <p>
          <div class="radio">
            <label>
...
&lt;/div&gt;
        ...
        <div class="tim-row" id="switch-row">
          ...
          <legend></legend>
          <p>If you want to use something more special than a checkbox, we recomment the toggle
            buttons.</p>
...
&lt;/div&gt;
        ...
        <div class="tim-row" id="dropdown-row">
          <h2> Dropdown </h2>
          <legend></legend>
          <p> We are very proud to present the dropdown which has a subtle animation. We also
            thought of another use-case: dropdown with flags. <b>IMPORTANT!</b> The focus state
            is <b>Purple</b> by default, on the dropdowns from the navbars will take the color
            of the navbar parent.</p>
...
&lt;/nav&gt;
          ...
          <p class="space-top">Besides the default navbar, we added 4 new colors: blue, green,
            orange, red. If you want to use one of them, you have to replace the <code>.navbar-default</code>
            or <code>navbar-primary</code> with the class for the chosen color <code>.navbar-info</code>,
            <code>.navbar-success</code>, <code>.navbar-warning</code>,
          ...
          <p class="space-top">
            ...
            <code>.navbar-transparent</code> is a special class that you can to use if you want
            the navbar to be transparent and then turn to color after scrolling 260px using the
            class <code>.navbar-color-on-scroll</code>. We recommend that the part of your page
            that has the transparent navbar contains something non-cluttered, like an image. If
            you want to see a nice example in details, check <a
            href="examples/profile-page.html" target="_blank">the Profile Page</a>.
          </p>
        ...
        <div class="tim-row" id="navpills-row">
          ...
          <legend></legend>
          <p>
            We changed the design for the Bootstrap nav pills into something a bit more fresh.
            We also added more color classes for customisation like
            <code>.nav-pills-primary</code>,<code>.nav-pills-info</code>,<code>.nav-pills-success</code>,<code>.nav-pills-warning</code>,<code>.nav-pills-danger</code>
          </p>
...
&lt;/ul&gt;
        ...
        <div class="tim-row" id="pagination-row">
          <h2>Pagination</h2>
          <legend></legend>
          <p>The Bootstrap pagination elements were customised to fit the overall theme. Besides
            the classic look, we also added the color classes to offer more customisation like
            <code>.pagination-info</code>, <code>.pagination-success</code>, <code>.pagination-warning</code>,
...
&lt;/ul&gt
        ...
        <div class="tim-row" id="progressbar-row">
          ...
          <p>The progress bars from Bootstrap hold the same classes and functionality. Adding this
            kit over your existing project will only make it look more clean. The default line
            is gray, each bar has a specific color but you can add some colors for the
            background lines using the next classes <code>.progress-line-primary</code>, <code>.progress-line-info</code>,
            <code>.progress-line-success</code>, <code>.progress-line-warning</code>, <code>.progress-line-danger</code>,
          </p>
          <div class="progress">
...
&lt;/div&gt;
        ...
        <div class="tim-row" id="sliders-row">
          <h2>Sliders</h2>
          <legend></legend>
          <p>We restyled noUIslider, while keeping the design consistent. You can use other
            classes for colors like <code>.slider-info</code>, <code>.slider-success</code>,
...
$(&#39;#sliderDouble&#39;).noUiSlider({
	...
	range: {
        ...
        <div class="tim-row" id="labels-row">
          <h2>Labels</h2>
          <legend></legend>
          <p>We restyled the default options for labels and we added the filled class, that can be
...
&lt;/table&gt;
      ...
      <div class="tim-row" id="datepicker-row">
        <h2>Datepicker</h2>
        <legend></legend>
        <p>The re-styled the Bootstrap datepicker. Checkout the <a
          href="http://www.eyecon.ro/bootstrap-datepicker/" target="_blank">Bootstrap
          Datepicker Full Documentation</a>.</p>
        <div class="row">
          <div class="col-md-4">
	...
	weekStart:1
      ...
      <div class="tim-row" id="modal-row">
        ...
        <p>We restyled the classic Bootstrap Modal and gave it a more simple look.<br/>
          <b>IMPORTANT!</b> Please make sure you place the modal body outside of the <code>div.wrapper</code>
          tag.
        </p>
        <!-- Button trigger modal -->
        <button class="btn btn-primary" data-toggle="modal" data-target="#myModal">Launch demo
          modal
        </button>
...
&lt;/div&gt;
      ...
      <div class="tim-row" id="tooltip-row">
        ...
        <button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="top"
                title="Tooltip on top">Button with Tooltip
        </button>
...
$(&apos;[data-toggle="tooltip"]&apos;).tooltip();
      ...
      <div class="tim-row" id="popover-row">
        ...
        <button type="button" class="btn btn-default" data-toggle="popover" data-placement="top"
                ...
                data-content="Here will be some very useful information about his popover.">On top
        </button>
        <pre class="prettyprint">
&lt;!-- markup --&gt;
...
$(&#39;[data-toggle=&quot;popover&quot;]&#39;).popover();
      ...
      <div class="tim-row" id="icons-row">
        ...
        <legend></legend>
        <p>
          We used the default <a href="https://design.google.com/icons/" target="_blank">Icons for
          the Material Design</a> which provided by Google.
        </p>
...
&lt;i class=&quot;material-icons&quot;&gt;face&lt;/i&gt;
      ...
      <div class="tim-row" id="notification-row">
        <h2> Notifications </h2>
        <legend></legend>
        <p>The new notifications are looking fresh and clean. They go great with the navbar. For
          these notifications examples we used the <code>.container-fluid</code> class, so they
          will be fluid, please use the class <code>.container</code> when you use them outside of
          the <code>.wrapper</code> so they will be alignd with the general page container.</p>
        ...
        <div class="alert alert-info">
          <div class="container-fluid">
            ...
            <b>Info alert:</b> You've got some friends nearby, stop looking at your phone and
            find them...
          </div>
        </div>
        ...
        <div class="alert alert-warning">
          <div class="container-fluid">
            ...
            <b>Warning Alert:</b> Hey, it looks like you still have the "copyright &copy; 2015"
            in your footer. Please update it!
          </div>
        </div>
        <div class="alert alert-danger">
          <div class="container-fluid">
            ...
            <b>Error Alert:</b> Damn man! You screwed up the server this time. You should find a
